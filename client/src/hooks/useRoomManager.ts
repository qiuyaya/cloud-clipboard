...
export const useRoomManager = () => {
  ...
  const handleJoinRoom = useCallback((data: JoinRoomRequest, isConnected: boolean) => {
  ...
  const handleJoinRoomWithPassword = useCallback((data: JoinRoomWithPasswordRequest, isConnected: boolean) => {
