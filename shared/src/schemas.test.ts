...
describe('Schema Validation Tests', () => {
  ...
  describe('TextMessageSchema', () => {
    ...
    it('should validate content line length and count', () => {
      ...
      expect(() => TextMessageSchema.parse({ ...validTextMessage, content: validMultiline })).not.toThrow();
      ...
      expect(() => TextMessageSchema.parse({ ...validTextMessage, content: tooManyLines })).toThrow();
    });
  });
  ...
  describe('FileInfoSchema', () => {
    ...
    it('should validate file size limits', () => {
      ...
      expect(() => FileInfoSchema.parse({ ...validFileInfo, size: 100 * 1024 * 1024 + 1 })).toThrow();
      expect(() => FileInfoSchema.parse({ ...validFileInfo, size: 100 * 1024 * 1024 })).not.toThrow();
    });
    ...
    it('should validate lastModified timestamp', () => {
      ...
      expect(() => FileInfoSchema.parse({ ...validFileInfo, lastModified: now + 86400001 })).toThrow();
