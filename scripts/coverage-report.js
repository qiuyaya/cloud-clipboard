...
function generateReport() {
  ...
  console.log(`Functions: ${formatPercentage(overallMetrics.functions)} (${coveredFunctions}/${totalFunctions})`);
  console.log(`Lines:     ${formatPercentage(overallMetrics.lines)} (${coveredLines}/${totalLines})`);
  console.log(`Statements: ${formatPercentage(overallMetrics.statements)} (${coveredStatements}/${totalStatements})`);
  console.log(`Branches:  ${formatPercentage(overallMetrics.branches)} (${coveredBranches}/${totalBranches})`);

  const packagesPassingThresholds = availablePackages.filter(([, result]) => result.thresholdsPassed).length;
